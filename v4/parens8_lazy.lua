...
function compile(exp, lookup)
	if type(exp) == "string" then
		...
		return where
			and function(k) return function()
				return k()(_upvalues[where][idx])
			end end
			or function(k) return function()
				return k()(_frame[idx])
			end end
	end
	...
	return args and function(k)
		return fun(function(fun)
			return args(function(args)
				return k()(function() return fun()(args()) end)
			end)
		end) 
	end or function(k)
		return fun(function(fun)
			return k()(function() return fun()() end)
		end)
	end
end

function builtin:quote(exp1)
	return function(k) return k()(function() return exp1 end) end
end
...
function builtin:callcc(exp1)
	...
	return function(k)
		return fun(function(fun) return k(fun()) end)
	end
end
